...
final class ViewController: UIViewController {
    ...
    private lazy var mainLabel: UILabel = {
        let label = UILabel()
        label.text = "abcdefg"
        label.textColor = #colorLiteral(red: 0.5957172513, green: 0, blue: 0, alpha: 1)
    ...
    private func setupAutoLayout() {
        ...
        emailTextField.bottomAnchor.constraint(equalTo: emailTextFieldView.bottomAnchor, constant: -1).isActive = true
        ...
        passwordSecureButton.bottomAnchor.constraint(equalTo: passwordTextFieldView.bottomAnchor, constant: -1).isActive = true
